#ifndef HiBmesonAnalyzer_bmesonAnalyzer_
#define HiBmesonAnalyzer_bmesonAnalyzer_
...
/**\class HiBmesonAnalyzer

   \author Gian Michele 將米坎尼 Innocenti
   \date   November 2010
*/
...
class HiBmesonAnalyzer : public edm::EDAnalyzer {
public:

  explicit HiBmesonAnalyzer(const edm::ParameterSet&);
