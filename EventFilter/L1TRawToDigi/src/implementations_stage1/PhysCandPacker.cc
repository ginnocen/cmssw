...
namespace l1t {
  namespace stage1 {
    ...
    IsoEGammaPacker::pack(const edm::Event& event, const PackerTokens* toks)
    {
       ...
       return process(105,107, *egammas, [](const l1t::EGamma& eg) -> bool { return eg.hwIso() == 1; });
    }
    ...
    NonIsoEGammaPacker::pack(const edm::Event& event, const PackerTokens* toks)
    {
       ...
       return process(101,103, *egammas, [](const l1t::EGamma& eg) -> bool { return eg.hwIso() == 0; });
    }
    ...
    CentralJetPacker::pack(const edm::Event& event, const PackerTokens* toks)
    {
       ...
       return process(93,95, *jets, [](const l1t::Jet& jet) -> bool { return !(jet.hwQual() & 2); });
    }
    ...
    ForwardJetPacker::pack(const edm::Event& event, const PackerTokens* toks)
    {
       ...
       return process(97,99, *jets, [](const l1t::Jet& jet) -> bool { return jet.hwQual() & 2; });
    }
    ...
    TauPacker::pack(const edm::Event& event, const PackerTokens* toks)
    {
       ...
       return process(999,999, *taus, [](const l1t::Tau& tau) -> bool { return true; });
    }
